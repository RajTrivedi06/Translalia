 ...
 *
 * The translations in this file are duplicates of those in /messages/*.json.
 * DO NOT add new translations here - add them to the message JSON files instead.
 */
...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    "guide.translationZoneHelper":
      "Briefly describe what zone of language you want to translate into",
    "guide.translationZoneExamples":
      "Examples: Hindi, Singlish, Rioplatense Spanish, a mix of French and Italian, medieval German, the whole range of world Englishes",
    "guide.translationIntent": "Translation Intent",
    "guide.translationIntentHelper":
      "Briefly describe your intention or goal for the translation",
    "guide.translationIntentExamples":
      "Examples: make it funny, make it sad, make it accessible to children, make it rhyme, make it poetic, make it political, make it spiritual",
  ...
  es: {
    ...
    "guide.translationZoneHelper":
      "Describe brevemente la zona lingüística a la que quieres traducir",
    "guide.translationZoneExamples":
      "Ejemplos: Hindi, Spanglish, español rioplatense, una mezcla de francés e italiano, alemán medieval, toda la gama de ingleses del mundo",
    "guide.translationIntent": "Intención de traducción",
    "guide.translationIntentHelper":
      "Describe brevemente tu intención u objetivo para la traducción",
    "guide.translationIntentExamples":
      "Ejemplos: hacerlo divertido, hacerlo triste, hacerlo accesible para niños, hacerlo rimar, hacerlo poético, hacerlo político, hacerlo espiritual",
    ...
    "guide.locked":
      "Bloqueado - traducción en progreso. Borra las traducciones para cambiar el formato.",
  ...
  hi: {
    ...
    "guide.translationZoneHelper":
      "भाषा क्षेत्र का संक्षेप में वर्णन करें जिसमें आप अनुवाद करना चाहते हैं",
    "guide.translationIntent": "अनुवाद उद्देश्य",
    "guide.translationIntentHelper":
      "अनुवाद के लिए अपने इरादे या लक्ष्य का संक्षेप में वर्णन करें",
    ...
    "guide.locked":
      "लॉक - अनुवाद प्रगति में है। स्वरूपण बदलने के लिए अनुवाद साफ़ करें।",
  ...
  ar: {
    ...
    "guide.translationZoneHelper":
      "صف بإيجاز منطقة اللغة التي تريد الترجمة إليها",
  ...
  fr: {
    ...
    "guide.translationZoneHelper":
      "Décrivez brièvement la zone linguistique vers laquelle vous voulez traduire",
    "guide.translationIntent": "Intention de traduction",
    "guide.translationIntentHelper":
      "Décrivez brièvement vos idées sur l'objectif de votre traduction",
    ...
    "guide.locked":
      "Verrouillé - traduction en cours. Effacez les traductions pour modifier le formatage.",
